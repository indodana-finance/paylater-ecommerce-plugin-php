...
const IDENTIFIER = `hosted.mysql.${ORGANIZATION}.${TEAM}.${PRODUCT}.opencartv3.dev`;
...
function writeCredential(username, password) {
  ...
  // Not sure why opencart has two config files, in upload/ and uploads/admin. 
  // Although they only use the one in uploads/admin
