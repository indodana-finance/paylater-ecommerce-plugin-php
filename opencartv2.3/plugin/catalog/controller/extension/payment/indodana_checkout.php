...
class ControllerExtensionPaymentIndodanaCheckout extends Controller implements IndodanaInterface
{
  private $data = [];
  ...
  {
    $total_rows = $this->model_extension_payment_indodana_checkout->getTotalRows($order['order_id']);
  ...
  {
    $discount_rows = $this->model_extension_payment_indodana_checkout->getDiscountRows($order['order_id']);
  ...
  {
    $shipping_rows = $this->model_extension_payment_indodana_checkout->getShippingRows($order['order_id']);
  ...
  {
    $tax_rows = $this->model_extension_payment_indodana_checkout->getTaxRows($order['order_id']);
  ...
  public function index()
  {
    ...
    $this->data['merchantConfirmPaymentUrl'] = $this->url->link('extension/payment/indodana_checkout/confirmOrder');

    return $this->load->view(
      'extension/payment/indodana_checkout_payment',
      $this->data
    );
  }
  ...
  private function loadModel()
  {
    ...
    $this->load->model('extension/payment/indodana_checkout');
