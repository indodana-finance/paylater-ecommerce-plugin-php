...
class ControllerExtensionPaymentIndodanaCheckout extends Controller {
  private $data = [];
  private $errors = [];
  ...
  public function index() 
  {
    ...
    $this->response->setOutput(
      $this->load->view('extension/payment/indodana_checkout',
      $this->data
    ));
  }
  ...
  private function initializeFormUI()
  {
    ...
    $this->data['form_action'] = $this->url->link(
      'extension/payment/indodana_checkout',
      'token=' . $this->session->data['token']
    );
    $this->data['form_cancel'] = $this->url->link(
      'extension/extension',
      'token=' . $this->session->data['token']
    );
  }
  ...
  {
    if (!$this->user->hasPermission('modify', 'extension/payment/indodana_checkout')) {
